; ModuleID = 'checkTimeout12.prelto.linked.bc'
...
define internal zeroext i8 @func_7(i16 zeroext %p_8, i16 zeroext %p_9, i32 %p_10) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %1, i8* bitcast ([8 x i16]* @func_7.l_51 to i8*), i32 16, i32 2, i1 false)
  %2 = bitcast [2 x [8 x i32]]* %l_76 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %2, i8* bitcast ([2 x [8 x i32]]* @func_7.l_76 to i8*), i32 64, i32 4, i1 false)
  %3 = add i16 %p_9, -1
  %4 = zext i16 %3 to i32
  %5 = icmp ult i32 %4, 6
  %6 = zext i1 %5 to i32
