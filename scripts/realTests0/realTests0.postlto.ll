; ModuleID = 'realTests0.postlto.bc'
...
; <label>:11                                      ; preds = %7
  %12 = load volatile i32* @g_9, align 4
  %13 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 3
  %14 = load i16* %13, align 2
  %15 = zext i16 %14 to i32
  %16 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 0
  %17 = load i16* %16, align 2
  %18 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 1
  %19 = load i16* %18, align 2
  %20 = trunc i16 %19 to i8
  %21 = call zeroext i8 @safe_mul_func_uint8_t_u_u(i8 zeroext 6, i8 zeroext %20) #3
  %22 = zext i8 %21 to i32
  %23 = call signext i16 @safe_lshift_func_int16_t_s_u(i16 signext %17, i32 %22) #3
  %24 = sext i16 %23 to i32
  store i32 %24, i32* @g_33, align 4
  %25 = load volatile i32* @g_9, align 4
  %26 = and i32 %24, %25
  %27 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 3
  %28 = load i16* %27, align 2
  %29 = zext i16 %28 to i32
  %30 = call i32 @safe_add_func_int32_t_s_s(i32 %26, i32 %29) #3
  %31 = call i32 @safe_mod_func_int32_t_s_s(i32 1604088068, i32 %30) #3
  %32 = icmp eq i32 %31, 0
...
; <label>:34                                      ; preds = %33, %11
  %35 = phi i32 [ 1, %11 ], [ 0, %33 ]
  %36 = call i32 @safe_div_func_uint32_t_u_u(i32 %15, i32 %35) #3
  %37 = load i16* @g_34, align 2
  %38 = trunc i16 %37 to i8
  %39 = call i32 @func_14(i8 zeroext 8, i32 %36, i8 zeroext %38, i32 8, i8 zeroext 6) #3
  %40 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 3
  %41 = load i16* %40, align 2
  %42 = zext i16 %41 to i32
  %43 = or i32 %39, %42
  %44 = trunc i32 %43 to i8
  %45 = call signext i8 @safe_div_func_int8_t_s_s(i8 signext %44, i8 signext 126) #3
  %46 = sext i8 %45 to i16
  %47 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 3
  %48 = load i16* %47, align 2
  %49 = zext i16 %48 to i32
  %50 = call signext i16 @safe_rshift_func_int16_t_s_u(i16 signext %46, i32 %49) #3
  %51 = trunc i16 %50 to i8
  %52 = load i16* @g_34, align 2
  %53 = sext i16 %52 to i32
  %54 = getelementptr inbounds [4 x i16]* %l_2, i32 0, i32 3
  %55 = load i16* %54, align 2
  %56 = trunc i16 %55 to i8
  %57 = call zeroext i8 @func_3(i8 signext %51, i32 %53, i8 zeroext %56, i32 6, i16 signext 6) #3
  br label %58

; <label>:58                                      ; preds = %34, %7
  %59 = load i16* @g_79, align 2
