; ModuleID = 'realTests0.prelto.linked.bc'
...
define internal i32 @func_14(i8 zeroext %p_15, i32 %p_16, i8 zeroext %p_17, i32 %p_18, i8 zeroext %p_19) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %1, i8* bitcast ([4 x i32]* @func_14.l_62 to i8*), i32 16, i32 4, i1 false)
  %2 = bitcast [8 x [9 x i8]]* %l_64 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %2, i8* getelementptr inbounds ([8 x [9 x i8]]* @func_14.l_64, i32 0, i32 0, i32 0), i32 72, i32 1, i1 false)
  br label %3
...
define internal i32 @func_37(i32 %p_38) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %1, i8* bitcast ([6 x i32]* @func_37.l_72 to i8*), i32 24, i32 4, i1 false)
  %2 = bitcast [3 x [1 x [2 x i32]]]* %l_81 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %2, i8* bitcast ([3 x [1 x [2 x i32]]]* @func_37.l_81 to i8*), i32 24, i32 4, i1 false)
