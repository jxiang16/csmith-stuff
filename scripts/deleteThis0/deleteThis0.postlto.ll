; ModuleID = 'deleteThis0.postlto.bc'
...
; <label>:14                                      ; preds = %4
  %15 = load volatile i32* @g_74, align 4
  %16 = sext i32 %15 to i64
  call void @transparent_crc(i64 %16, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 0) #3
  %17 = load i32* @crc32_context, align 4
  %18 = xor i32 %17, -1
  %19 = call i32 @platform_main_end(i32 %18, i32 0) #3
  ret i32 %19
}
