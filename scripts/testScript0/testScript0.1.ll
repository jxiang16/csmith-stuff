...
; <label>:6                                       ; preds = %25, %0
  ...
  br i1 %exitcond3, label %8, label %27
...
; <label>:9                                       ; preds = %22, %8
  ...
  %exitcond1 = icmp ne i32 %10, 3
  br i1 %exitcond1, label %11, label %24
...
; <label>:12                                      ; preds = %19, %11
  ...
  %exitcond = icmp ne i32 %13, 6
  br i1 %exitcond, label %14, label %21
